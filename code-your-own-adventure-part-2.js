                    ...
                    if (answer === "YES") {
                        ...
                        while (inRoom3 === true) {
                            lobbyDirectory = function(answer) {
                                if (answer === "INSPECT CHAIRS" && string == 1){
                                    alert("You already looked over here.");
                                }
                                if (answer === "INSPECT CHAIRS" && string == 0) {
                                ...
                                if (answer == "TRY TO FIGURE OUT WHERE THE COLD BREEZE IS COMING FROM" && ventKey == 1) {
                                    alert("You've already looked up there.");
                                }
                                if (answer == "TRY TO FIGURE OUT WHERE THE COLD BREEZE IS COMING FROM" && ventKey == 0) {
